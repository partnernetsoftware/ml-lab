...
# 2020-08-14 borrow from https://mlog.club/article/5877276
import os
os.environ["IEX_API_KEY"] = "pk_f2d165c0b43b4bd3b253c3f323de9dc9 "
...
#example
# python trend.py -c GOOGL -s 2019-01-01 -e 2019-02-19 -f google_stock_trend.png
# python trend.py -c CSCO -s 2019-01-01 -e 2019-02-19 -f cisco_stock_trend.png
# python trend.py -c SINA -s 2019-01-01 -e 2019-02-19 -f sina_stock_trend.png
# python trend.py -c BIDU -s 2019-01-01 -e 2019-02-19 -f baidu_stock_trend.png
# python trend.py -c NTES -s 2019-01-01 -e 2019-02-19 -f netease_stock_trend.png
# python trend.py -c CSCO -s 2019-01-01 -e 2019-02-19 -f cisco_stock_trend.png
